...
#define PATTERN_OPCODE_LABEL_AS_REG             "^([a-zA-Z]+) (\\(\\$[\\w]*\\))\\s+as\\s+(single|double|quad)\\s*->\\s*([r|R][0-9a-zA-Z]+)$"
#define PATTERN_OPCODE_REG_REG                  "^([a-zA-Z]+) ([r|R][0-9a-zA-Z]+)\\s*->\\s*([r|R][0-9a-zA-Z]+)$"

#define PATTERN_OPCODE_REG_MEMORY_REG           "^([a-zA-Z]+) \\(([r|R][0-9a-zA-Z]+)\\s*\\+\\s*(0x[0-9a-fA-F]+|[0-9]+)\\)\\s*->\\s*([r|R][0-9a-zA-Z]+)$"
#define PATTERN_OPCODE_REG_MEMORY_AS_REG        "^([a-zA-Z]+) \\(([r|R][0-9a-zA-Z]+)\\s*\\+\\s*(0x[0-9a-fA-F]+|[0-9]+)\\)\\s+as\\+(single|double|quad)\\s*->\\s*([r|R][0-9a-zA-Z]+)$"
#define PATTERN_OPCODE_REG_REG_MEMORY_AS        "^([a-zA-Z]+) ([r|R][0-9a-zA-Z]+)\\s*->\\s*\\(([r|R][0-9a-zA-Z]+)\\s*\\+\\s*(0x[0-9a-fA-F]+|[0-9]+)\\)\\s+as\\+(single|double|quad)$"
#define PATTERN_OPCODE_REG_REG_MEMORY           "^([a-zA-Z]+) ([r|R][0-9a-zA-Z]+)\\s*->\\s*\\(([r|R][0-9a-zA-Z]+)\\s*\\+\\s*(0x[0-9a-fA-F]+|[0-9]+)\\)$"

#define PATTERN_OPCODE_VALUE_REG_MEMORY         "^([a-zA-Z]+) (0x[0-9a-fA-F]+|[0-9]+)\\s*->\\s*\\(([r|R][0-9a-zA-Z]+)\\s*\\+\\s*(0x[0-9a-fA-F]+|[0-9]+)\\)$"
#define PATTERN_OPCODE_VALUE_REG_MEMORY_AS      "^([a-zA-Z]+) (0x[0-9a-fA-F]+|[0-9]+)\\s*->\\s*\\(([r|R][0-9a-zA-Z]+)\\s*\\+\\s*(0x[0-9a-fA-F]+|[0-9]+)\\)\\s+as\\+(single|double|quad)$"

#define PATTERN_OPCODE_VALUE_REG                "^([a-zA-Z]+) (0x[0-9a-fA-F]+|[0-9]+)\\s*->\\s*([r|R][0-9a-zA-Z]+)$"

#define PATTERN_OPCODE_LABEL_REG                "^([a-zA-Z]+) (\\$\\w*)\\s*->\\s*([r|R][0-9a-zA-Z]+)$"
#define PATTERN_OPCODE_LABEL                    "^([a-zA-Z]+) (\\$\\w*)$"
...
#define PATTERN_OPCODE_ADDR_AS_REG              "^([a-zA-Z]+) \\(\\s*(0x[0-9a-fA-F]+|[0-9]+)\\)\\s+as\\+(single|double|quad)\\s*->\\s*([r|R][0-9a-zA-Z]+)$"
#define PATTERN_OPCODE_REG_ADDR_AS              "^([a-zA-Z]+) \\(\\s*(0x[0-9a-fA-F]+|[0-9]+)\\)\\s+as\\+(single|double|quad)\\s*->\\s*([r|R][0-9a-zA-Z]+)\\s+as\\+(single|double|quad)$"
#define PATTERN_OPCODE_VALUE_ADDR_AS            "^([a-zA-Z]+) (0x[0-9a-fA-F]+|[0-9]+)\\s*->\\s*\\((0x[0-9a-fA-F]+|[0-9]+)\\)\\s+as\\+(single|double|quad)$"
